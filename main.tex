...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#Key data type #2: Spatial Weights - listw}
\hlcom{#listw is an old-style (S3) class, so has no formal definition}
\hlcom{# it is based on the Spatial neighbors ("nb") class}
\hlcom{#run the following: vignette("nb", package = "spdep") #read more}
\end{alltt}
\end{kframe}
\end{knitrout}
